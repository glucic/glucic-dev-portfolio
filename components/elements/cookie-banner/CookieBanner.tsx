...
export default function CookieBanner({onClose}: { onClose?: () => void }) {
    ...
    return (
        <>
            <div
                className="fixed bottom-0 left-0 w-full bg-[var(--secondary)] dark:bg-[var(--muted)] dark:text-[var(--foreground)] text-[var(--background)] px-6 py-4 z-50 shadow-lg animate-slide-up-fade">
                <div
                    ...
                    <div
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-blue-500 rounded transition-all duration-200 transform hover:scale-105"
                        >
                            Einstellungen
                        </button>
                        ...
                        <button
                            onClick={acceptAll}
                            className="px-4 py-2 bg-[var(--success)] rounded transition-all duration-200 transform hover:scale-105 hover:bg-opacity-90"
                        >
                            Zustimmen
                        </button>
                        ...
                        <button
                            onClick={declineAll}
                            className="px-4 py-2 bg-[var(--destructive)] rounded transition-all duration-200 transform hover:scale-105 hover:shadow-md hover:bg-opacity-90"
                        >
                            Ablehnen
                        </button>
                    </div>
